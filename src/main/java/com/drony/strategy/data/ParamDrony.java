...
public class ParamDrony implements EdgeOrderParam {
    ...
    private double indentPercentPennachio = 0;
...
//, options = { StrategyTypeEnum.FULL,StrategyTypeEnum.LONG,StrategyTypeEnum.SHORT})
    ...
    public double getIndentPercentPennachio() {
        return indentPercentPennachio;
    }

    public void setIndentPercentPennachio(double indentPercentPennachio) {
        this.indentPercentPennachio = indentPercentPennachio;
    }
    ...
    public String toString() {
        return "ParamDrony{" +
            ...
            ", indent=" + indent +
            ", indentPercentPennachio=" + indentPercentPennachio +
            ", cap_abs=" + cap_abs +
            ", cap_perc=" + cap_perc +
            ", cap_attn=" + cap_attn +
            ", floor_abs=" + floor_abs +
